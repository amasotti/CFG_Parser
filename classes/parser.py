...
Implementation of the Parser as class
...
class Parser(object):
    ...
    def grammar_from_file(self, grammar):
        ...
        """
        gram = CFGGrammar(parser=None, rules_as_file=grammar)
    ...
    def grammar_from_string(self, grammar):
        ...
        :return:
        """
        gram = [x.replace("->", "").split() for x in grammar.split("\n")]
        self.grammar = CFGGrammar.chomskyan_normal_form(gram)
